...
> **当前版本: v2.23.0** · Author: elecvoid243 · 最后更新: 2026-08-11
...
13. **版本号统一**：当前版本统一为 **v2.23.0**。发布时同步更新 `metadata.yaml` 的 `version` 字段
...
> Author: elecvoid243 · 本文档同步至 v2.23.0 (2026-08-11)
