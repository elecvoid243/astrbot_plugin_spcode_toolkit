...
def test_routes_table_has_forty_six_endpoints() -> None:
    ...
    - 2026-07-17~28: +file-write / file-rename / file-remove / file-binary /
    ...
    assert routes == {
        ...
        "/spcode/project-load",  # 2026-07-28 — 静默加载项目 (POST)
        "/spcode/plan-mode",
        ...
        "/spcode/git-reset",  # v2.27.0 (2026-09-09) 重置当前分支到指定 commit
...
class TestGitCommitAmendEndpointSmoke:
    """2026-08-13 git-commit-amend route registration smoke."""
    ...
    def test_git_commit_amend_route_registered(self) -> None:
        from tools.webapi import git_commit_amend
